...
const Index = () => {
  ...
  return <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background px-6">
      ...
      <div className="relative z-10 flex max-w-4xl flex-col items-center text-center">
        ...
        {/* Main message */}
        <h2 className="fade-in-delay mb-6 text-4xl font-light leading-tight tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl">Enabling startups and SMEs to access the defence market.</h2>
